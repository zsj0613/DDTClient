package road.ui
{
	...
	import road.geom.IntDimension;
	import road.geom.IntPoint;
	import road.geom.IntRectangle;
	...
	public interface IViewprot extends IDisplayObject
	{
		 ...
		 */
		function set verticalUnitIncrement(increment:int):void;
		
		/**
		 * Sets the block value for the Vertical scrolling.
		 */
		function set verticalBlockIncrement(increment:int):void;
		
		/**
		 * Sets the unit value for the Horizontal scrolling.
		 */
		function set horizontalUnitIncrement(increment:int):void;
		
		/**
		 * Sets the block value for the Horizontal scrolling.
		 */
		function set horizontalBlockIncrement(increment:int):void;       
		 ...
		 */
		function set viewPosition(p:IntPoint):void;
