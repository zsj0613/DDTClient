package ddt.tofflist.requests
{
	...
	public class TofflistConsortiaExloitAccumulateList extends CompressTextLoader
	{
		public var list: Array;
		private var _xml: XML;
		private static const PATH:String = "CelebByConsortiaHonor.xml";
		private var _path:String;
		public function TofflistConsortiaExloitAccumulateList(path:String = "CelebByConsortiaHonor.xml")
		{
			_path = path;
