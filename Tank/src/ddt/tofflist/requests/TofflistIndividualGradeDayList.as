package ddt.tofflist.requests
{
	...
	public class TofflistIndividualGradeDayList extends CompressTextLoader
	{
		public var list:Array;
		private var _xml:XML;
		private static const PATH:String = "CelebByDayGPList.xml";
		private var _path:String;
		public function TofflistIndividualGradeDayList(path:String = "CelebByDayGPList.xml")
		{
			_path = path;
