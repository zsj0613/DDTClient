package ddt.tofflist.requests
{
	...
	public class TofflistEffortValueAccumulateList extends CompressTextLoader
	{
		public var list: Array;
		private var _xml: XML;
		private static const PATH:String = "CelebByAchievementPointList.xml";
		private var _path:String;
		public function TofflistEffortValueAccumulateList(path:String = "CelebByAchievementPointList.xml", paras:Object=null)
		{
			_path = path;
