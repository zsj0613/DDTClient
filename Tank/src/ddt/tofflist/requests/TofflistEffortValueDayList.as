package ddt.tofflist.requests
{
	...
	public class TofflistEffortValueDayList extends CompressTextLoader
	{
		public var list: Array;
		private var _xml: XML;
		private static const PATH:String = "CelebByAchievementPointDayList.xml";
		private var _path:String;
		public function TofflistEffortValueDayList(path:String = "CelebByAchievementPointDayList.xml", paras:Object=null)
		{
			_path = path;
