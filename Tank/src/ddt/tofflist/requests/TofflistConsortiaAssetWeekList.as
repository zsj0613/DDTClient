package ddt.tofflist.requests
{
	...
	public class TofflistConsortiaAssetWeekList extends CompressTextLoader
	{
		public var list: Array;
		private var _xml: XML;
		private static const PATH:String = "CelebByConsortiaWeekRiches.xml";
		private var _path:String;
		public function TofflistConsortiaAssetWeekList(path:String = "CelebByConsortiaWeekRiches.xml")
		{
			_path = path;
