package ddt.church.utils{
	...
	public class MTween extends EventDispatcher {
		//已更改并且屏幕已更新
		...
		public function MTween(obj : DisplayObject) {
			this._obj = obj;
		}
		...
		public function start(time : Number,prop : String,finish : Number,prop2 : String = null,finish2 : Number = 0) : void {
			...
			_prop = prop;
			_finish = finish;
			vectors = finish - _obj[_prop];
			_prop2 = prop2;
			if(_prop2) {
				_finish2 = finish2;
				vectors2 = finish2 - _obj[_prop2];
			}			currentCount = 0;
			repeatCount = time / 1000 * 25 ;
