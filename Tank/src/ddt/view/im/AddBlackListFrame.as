package ddt.view.im
{
	...
	public class AddBlackListFrame extends HTipFrame
	{
		...
		public function AddBlackListFrame(controller:IMController)
		{
			_controller = controller;
			super();
			titleText = LanguageMgr.GetTranslation("ddt.view.im.AddBlackListFrame.titleText");
			//titleText = "添加黑名单";
