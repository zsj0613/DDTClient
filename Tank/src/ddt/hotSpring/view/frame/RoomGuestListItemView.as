package ddt.hotSpring.view.frame
{
	...
	import tank.hotSpring.HotSpringGuestItemAsset;
	import ddt.view.common.LevelIcon;
	
	public class RoomGuestListItemView  extends HotSpringGuestItemAsset implements ISelectable
	{
		private var _info:PlayerInfo;
		
		public function RoomGuestListItemView(info:PlayerInfo)
		{
			_info = info;
